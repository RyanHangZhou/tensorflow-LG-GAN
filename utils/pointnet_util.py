...
def sample_and_group2(npoint, radius, nsample, xyz, points, knn=False, use_xyz=True):
    '''
    Input:
        npoint: int32
        radius: float32
...
def pointnet_sa_module(xyz, points, npoint, radius, nsample, mlp, mlp2, group_all, is_training,
    ...
    with tf.variable_scope(scope) as sc:
        ...
        #new_points (4, 2048, 1, 64)
        #new_points (4, 1024, 1, 128)
        #new_points (4, 512, 1, 256)
        #new_points (4, 256, 1, 512)
